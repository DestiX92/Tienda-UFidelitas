...
public class FirebaseStorageService 
{
    ...
    // Los métodos convertToFile, uploadToFirebase y getFormattedNumber
    // no se visualizan en la imagen original
    ...
    private String uploadToFirebase(File file, String folder, String fileName) throws IOException 
    {
        ...
        // El objeto `storage` ya tiene credenciales del servicio configuradas
